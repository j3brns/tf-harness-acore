...
_CF_WAF_ARN_PATTERN = re.compile(
    r"^arn:aws:wafv2:eu-central-1:[0-9]{12}:global/webacl/[^/]+/[^/]+$"
)
...
def test_accepts_well_formed_cf_waf_arn():
    ...
    arn = "arn:aws:wafv2:eu-central-1:123456789012:global/webacl/my-cf-acl/aabbccdd-1234-5678-abcd-ef1234567890"
...
def test_accepts_short_name_and_id():
    ...
    arn = "arn:aws:wafv2:eu-central-1:000000000001:global/webacl/x/y"
    assert _is_valid_cf_waf_arn(arn), f"Expected valid, got invalid for: {arn}"
...
def test_rejects_regional_scope_arn():
    """REGIONAL-scope (non-eu-central-1) WAFv2 ARN must be rejected for CloudFront."""
    arn = "arn:aws:wafv2:eu-central-1:123456789012:regional/webacl/my-acl/abc123"
...
def test_rejects_non_us_east_1_region():
    """Only eu-central-1 is valid for CLOUDFRONT-scope WAFv2."""
...
def test_rejects_partial_arn():
    ...
    arn = "arn:aws:wafv2:eu-central-1:123456789012:global/webacl/no-id"
...
def test_rejects_trailing_slash():
    ...
    arn = "arn:aws:wafv2:eu-central-1:123456789012:global/webacl/my-acl/"

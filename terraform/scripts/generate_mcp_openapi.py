...
def build_openapi_spec(all_tools: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
    ...
    for server_name in sorted(all_tools):
        ...
        spec["tags"].append({"name": server_name, "description": f"Tools from {server_name} MCP server"})
...
def main():
    ...
    search_patterns = [os.path.join(mcp_servers_dir, "*/handler.py"), os.path.join(mcp_servers_dir, "*/server.py")]
    ...
    for file_path in files:
        ...
        if tools:
            ...
            print("  No TOOLS dictionary found.")
